...
class ProductControl extends Component {
    ...
    componentDidMount() {
        axios.get(`${this.API_BASE}/api/products`)
            .then(res => {
                console.log(res);
    ...
    handleAddingNewProduct = (newProduct) => {
        axios.post(`${this.API_BASE}/api/products`, newProduct)
            .then(res => console.log(res.data));
    ...
    handleDeletingProduct = (id) => {
        axios.delete(`${this.API_BASE}/api/products/${id}`)
            .then(res => console.log(res.data))
    ...
    handleEditingProduct = (editedProduct) => {
        axios.put(`${this.API_BASE}/api/products/${this.state.selectedProduct._id}`, editedProduct)
            .then(res => console.log(res.data));
        this.setState({
            editProduct: false,
            formVisibleOnPage: false
